...
namespace GymManagement
{
    public partial class DashboardControl : UserControl
    {
        ...
        {
            SqlConnection con = new SqlConnection(constr);
            SqlCommand cmd = new SqlCommand("Select MemberID, Name, JoiningDate, RenewalDate from MemberTable Where RenewalDate Between '" + dateTime.Value.ToString("MM/dd/yyyy") + "' And '" + dateTime.Value.AddDays(7).ToString("MM/dd/yyyy") + "' ", con);
